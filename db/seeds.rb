...
###小１の孫データ{name: ''}
grade1_1.children.create([{name: '説明文'},{name: '物語'},{name: '詩'},{name: '読む'},{name: '書く'},{name: '話す・聞く'},{name: '言葉'},{name: '漢字'},{name: '作文'}])
grade1_2.children.create([{name: '100までの数'},{name: '順序数'},{name: '数量の表現'},{name: '1位数の加法'},{name: '1位数の減法'},{name: '2位数の加法・減法'},{name: '3口の加法・減法'},{name: 'くり上がりのあるたし算'},{name: 'くり下がりのあるひき算'},{name: '100をこえる数'},{name: '時計の読み方'},{name: '長さの比較'},{name: '面積の比較'},{name: '平面図形や立体図形の観察'},{name: '平面図形や立体図形の構成'},{name: '求大・求小'}])
grade1_3.children.create([{name: '歌唱'},{name: '合奏'},{name: 'リズム'},{name: '鑑賞'},{name: 'その他'}])
grade1_4.children.create([{name: '絵画'},{name: 'デザイン'},{name: '工作'},{name: '版画'},{name: 'ものづくり'},{name: '造形あそび'},{name: '鑑賞'},{name: 'その他'}])
grade1_5.children.create([{name: '体つくり運動'},{name: '陸上運動'},{name: '器械運動'},{name: 'ボール運動'},{name: '水泳'},{name: 'なわとび'},{name: '表現運動'},{name: 'その他'}])
grade1_6.children.create([{name: '学校生活の始まり'},{name: '学校生活'},{name: '植物の飼育'},{name: '季節の変化(夏)'},{name: '生物との関わり'},{name: '季節の変化(秋)'},{name: '身近な自然の利用'},{name: '家庭生活との関わり'},{name: '季節の変化(冬)'},{name: '1年生の振り返り'}])
grade1_7.children.create([{name: '正直・明朗・公正・責任'},{name: '家族愛'},{name: '生命の尊重'},{name: '思いやり・信頼'},{name: 'いじめ・差別'},{name: '不撓不屈・努力'},{name: '生き方'},{name: 'その他'}])
grade1_8.children.create([{name: '慣れ親しむ'}])
grade1_9.children.create([{name: '学級会'},{name: '行事関係'},{name: 'アイスブレイク'},{name: 'その他'}])
grade1_10.children.create([{name: '黒板メッセージ・黒板アート'}])
...
grade6_10.children.create([{name: 'Unit1'},{name: 'Unit2'},{name: 'Unit3'},{name: 'Unit4'},{name: 'Unit5'},{name: 'Unit6'},{name: 'Unit7'},{name: 'Unit8'},{name: 'Unit9'}])
...
##学年共通の子データ
grade7_1 = grade7.children.create(name: '国語')
grade7_2 = grade7.children.create(name: '社会')
grade7_3 = grade7.children.create(name: '算数')
grade7_4 = grade7.children.create(name: '理科')
grade7_5 = grade7.children.create(name: '音楽')
grade7_6 = grade7.children.create(name: '図工')
grade7_7 = grade7.children.create(name: '家庭')
grade7_8 = grade7.children.create(name: '体育')
grade7_9 = grade7.children.create(name: '生活')
grade7_10 = grade7.children.create(name: '道徳')
grade7_11 = grade7.children.create(name: '英語')
grade7_12 = grade7.children.create(name: '総合')
grade7_13 = grade7.children.create(name: '学活')
grade7_14 = grade7.children.create(name: '特別支援')
grade7_15 = grade7.children.create(name: 'その他')

###学年共通の孫データ{name: ''}
grade7_1.children.create([{name: '読む力'},{name: '書く力'},{name: '話す力・聞く力'},{name: '読む力'},{name: '言語'}])
grade7_2.children.create([{name: '資料の活用'},{name: '地図帳の活用'},{name: 'その他'}])
grade7_3.children.create([{name: '図形'},{name: '数と計算'},{name: '数量関係'},{name: '量と測定'}])
grade7_4.children.create([{name: '物質・エネルギー'},{name: '生命・地球'}])
grade7_5.children.create([{name: '歌唱'},{name: '合奏'},{name: 'リズム'},{name: '鑑賞'},{name: 'その他'}])
grade7_6.children.create([{name: '絵画'},{name: 'デザイン'},{name: '工作'},{name: '版画'},{name: 'ものづくり'},{name: '造形あそび'},{name: '鑑賞'},{name: 'その他'}])
grade7_7.children.create([{name: '家庭生活と家族'},{name: '日常の食事と調理の基礎'},{name: '快適な衣類と住まい'},{name: '身近な消費生活と環境'}])
grade7_8.children.create([{name: '体つくり運動'},{name: '陸上運動'},{name: '器械運動'},{name: 'ボール運動'},{name: '水泳'},{name: 'なわとび'},{name: '表現運動'},{name: 'その他'}])
grade7_9.children.create([{name: '学校生活'},{name: '植物の飼育'},{name: '季節の変化'},{name: '生物との関わり'},{name: '身近な自然の利用'},{name: '家庭生活との関わり'}])
grade7_10.children.create([{name: '正直・明朗・公正・責任'},{name: '家族愛'},{name: '生命の尊重'},{name: '思いやり・信頼'},{name: 'いじめ・差別'},{name: '不撓不屈・努力'},{name: '生き方'},{name: '学級生活'},{name:'ジレンマ'},{name:'その他'}])
grade7_11.children.create([{name: '慣れ親しむ'},{name: 'その他'}])
grade7_12.children.create([{name: 'まちづくり教育'},{name: '情報教育'},{name: '福祉教育'},{name: '自然教育'},{name: 'キャリア教育'},{name: '国際理解教育'},{name: 'その他'}])
grade7_13.children.create([{name: '学級会'},{name: '行事関係'},{name: 'アイスブレイク'},{name: 'その他'}])
grade7_14.children.create([{name: '学校生活'},{name: '学習'},{name: 'その他'}])
grade7_15.children.create([{name: '黒板メッセージ・黒板アート'}])